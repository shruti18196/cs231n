        ...
        for c in range(C):  # For each channel
            for j in range(dout_H):  # For each row of dout.
                for i in range(dout_W):  # For each col of dout.
                    ...
                    dx[n,c, j*stride:j*stride+pool_height, i*stride:i*stride+pool_width][max_coord] = dout[n, c, j, i] #### values get overlapped hence wasted
