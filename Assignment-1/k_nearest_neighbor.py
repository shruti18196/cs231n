...
##      print(pow((X[0]-self.X_train[j]),2))
##      
      
##      print(pow((X[0]-self.X_train[j]),2).shape)
  ...
  def compute_distances_one_loop(self, X):
    ...
    num_train = self.X_train.shape[0]
    dists = np.zeros((num_test, num_train))
##    print(pow((X[0]-self.X_train[:,:]),2))
##    print(np.sum(pow((X[0]-self.X_train[:,:]),2),axis=1))
##    print(pow(np.sum(pow((X[0]-self.X_train[:,:]),2),axis=1),0.5))
##    dists[0,:]=(pow(np.sum(pow((X[0]-self.X_train[:,:]),2),axis=1),0.5))
##    print(dists[0,:])
    for i in xrange(num_test):
      #######################################################################
      # TODO:                                                               #
      ...
      #######################################################################
        dists[i,:]=(pow(np.sum(pow((X[i]-self.X_train[:,:]),2),axis=1),0.5))
        
##      dists[i,:]=pow(np.sum(power),0.5)
      #######################################################################
      #                         END OF YOUR CODE                            #
      #######################################################################
    return dists
...
##      print(closest_y)
##      y_pred[i,j]=self.y_train[closest_y[j]]
##  
##      print(y_pred[i])
